...
class Directorys():
	...
	def Run(self, comment):
		...
		# LABELS
		labelOffset = 25
		project = Label(text = comment, bg = bgColour, fg = 'white').place(x=8, y=5)
		scene = Label(text = comment, bg = bgColour, fg = 'white').place(x=14, y=5+labelOffset)
		shots = Label(text = comment, bg = bgColour, fg = 'white').place(x=15.5, y=30+labelOffset)
		## INPUT FIELDS
